...
public class NavigationPresenterTest {
    ...
    public void initialize() throws Exception {
        ...
        Assert.assertTrue(tableMap.containsKey(KipConstants.DrawerMenu.ALL_FAMILIES));
        Assert.assertTrue(tableMap.containsKey(KipConstants.DrawerMenu.ALL_CLIENTS));
        Assert.assertTrue(tableMap.containsKey(KipConstants.DrawerMenu.CHILD_CLIENTS));
        Assert.assertTrue(tableMap.containsKey(KipConstants.DrawerMenu.ANC));
        Assert.assertTrue(tableMap.containsKey(KipConstants.DrawerMenu.ANC_CLIENTS));
    }
