...
@PrepareForTest({KipApplication.class, Utils.class, VaccineSchedule.class, ServiceSchedule.class})
public class KipProcessorForJavaTest {
    ...
    private KipProcessorForJava processorForJava;
    ...
    @Before
    public void setUp() {
        processorForJava = Mockito.spy(KipProcessorForJava.getInstance(Mockito.mock(Context.class)));
    }
