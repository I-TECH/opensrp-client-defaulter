...
public class KipChildJsonFormUtilsTest {
    ...
    public void getMetadataForEditForm() throws Exception {
        ...
        childDetails.put(KipConstants.KEY.LAST_NAME, "last");
        childDetails.put(KipConstants.KEY.MIDDLE_NAME, "middle");
        ...
        Assert.assertEquals("first", JsonFormUtils.getFieldValue(stepOneFields, KipConstants.KEY.FIRST_NAME));

        Assert.assertEquals("last", JsonFormUtils.getFieldValue(stepOneFields, KipConstants.KEY.LAST_NAME));

        Assert.assertEquals("30-06-2010", JsonFormUtils.getFieldValue(stepOneFields, Constants.DATE_BIRTH));

        Assert.assertEquals("Middle", JsonFormUtils.getFieldValue(stepOneFields, KipConstants.KEY.MIDDLE_NAME));
        ...
        Assert.assertEquals("Nrc Number", JsonFormUtils.getFieldValue(stepOneFields, KipConstants.KEY.MOTHER_NRC_NUMBER));

        Assert.assertEquals("0232453923", JsonFormUtils.getFieldValue(stepOneFields, KipConstants.KEY.MOTHER_SECOND_PHONE_NUMBER));
    }
