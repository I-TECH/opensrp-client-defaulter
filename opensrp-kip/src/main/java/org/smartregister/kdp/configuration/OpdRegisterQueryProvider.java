...
public class OpdRegisterQueryProvider extends OpdRegisterQueryProviderContract {
    ...
    public String mainSelectWhereIDsIn() {
        ...
        String oneDayAgo = OpdUtils.convertDate(latestValidCheckInDate, OpdDbConstants.DATE_FORMAT);
        String sqlQuery =
                "Select  d.id as _id , d.first_name , d.last_name , '' AS middle_name , d.gender , d.dob,d.phone_number, d.covid_19_defaulter, d.reminders,d.defaulter_status,d.last_vaccine,d.covid_defaulter,'' AS home_address , c.first_name as mother_first_name, c.last_name as mother_last_name, \n" +
